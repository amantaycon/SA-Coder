    ...
    <main>
        ...
        <div id="mainpri" class="center flex_c" style="padding-left: 0;padding-bottom: 0;">
            <div class="macon" style="margin-top: -100px;">
                <h3 class="cor_bla hfont center" style="margin-bottom: -4vw;">Unauthorized Access</h3>
                <div class="center">
                    <h1 class="center cor_ora ferror">401</h1>
                </div>
                <center>
                    <p class="pfont center cor_bla" style="margin-top: -10px;">You are not authorized to access this
                        resource.</p>
                </center>
                <hr class="hr">
                <center>
