    ...
    <main>
        ...
        <div id="mainpri" class="center flex_c" style="padding-left: 0;padding-bottom: 0;">
            <div class="macon" style="margin-top: -100px;">
                <h3 class="cor_bla hfont center" style="margin-bottom: -4vw;">Internal Server Error</h3>
                <div class="center">
                    <h1 class="center cor_ora ferror">500</h1>
                </div>
                <center>
                    <p class="pfont center cor_bla" style="margin-top: -10px;">The server encountered an internal error
                        or misconfiguration and was unable to complete your request.</p>
                </center>
                <hr class="hr">
                <center>
